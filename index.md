...
- **Application** refers to tissu-agent, the software program provided by the Company.
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Tissu, tbilisi,Georgia g.lortkipanidze str.7.
...
- **Website** refers to Tissu Georgia, accessible from https://www.instagram.com/thetissushop/.
